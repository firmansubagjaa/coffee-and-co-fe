...
export const ProductCardSkeleton: React.FC = () => {
  return (
    <div className="bg-white rounded-3xl shadow-sm border border-coffee-50 flex flex-col h-full overflow-hidden">
      <div className="p-3">
        {/* Image Placeholder */}
        <div className="relative aspect-square rounded-2xl bg-coffee-100/50 animate-pulse" />
      </div>
