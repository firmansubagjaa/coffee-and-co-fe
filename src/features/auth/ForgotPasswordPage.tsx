    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="space-y-2">
            <Label htmlFor="email" className={errors.email ? "text-red-500" : ""}>{t('auth.forgotPassword.emailLabel')}</Label>
            <div className="relative">
                ...
                <Input 
                    ...
                    className={cn("pl-10", errors.email && "border-red-500 focus-visible:ring-red-400")}
                    {...register("email")}
                    autoFocus
                />
            </div>
        ...
        <div className="text-center pt-4">
             <Link to="/login" className="inline-flex items-center gap-2 text-sm font-bold text-coffee-600 hover:text-coffee-900 transition-colors">
