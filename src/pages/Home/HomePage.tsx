...
export const HomePage: React.FC = () => {
  ...
  const scroll = (direction: "left" | "right") => {
    if (scrollRef.current) {
      ...
      const cardWidth =
        current.children[0]?.getBoundingClientRect().width || 300;
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-coffee-950">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 md:mb-16 gap-4 md:gap-8">
            ...
            <div className="flex items-center gap-6">
              ...
              <Button
                ...
                className="hidden sm:inline-flex gap-3 text-lg font-medium hover:bg-transparent hover:text-coffee-600 dark:hover:text-coffee-300 group"
              >
        ...
        {/* About Teaser */}
        <section
          className="py-32 bg-cream-50 dark:bg-coffee-900 relative overflow-hidden"
            ...
            <div className="relative order-2 lg:order-1">
              <div className="relative z-10">
                <img
                  ...
                  alt="Skilled barista carefully pouring latte art into a ceramic cup"
                ...
                <div className="absolute -bottom-10 -right-10 md:bottom-10 md:-right-10 bg-white dark:bg-coffee-800 p-8 rounded-[2rem] shadow-xl max-w-xs animate-float hidden md:block border border-coffee-50 dark:border-coffee-700">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <p className="text-sm text-coffee-500 dark:text-coffee-400 font-medium">
                        {t("home.freshness.title")}
                      </p>
                      <p className="text-lg font-bold text-coffee-900 dark:text-white">
                        {t("home.freshness.subtitle")}
                      </p>
                    </div>
                  </div>
              ...
              {/* Decorative Elements */}
              <div
                className="absolute -top-10 -left-10 w-40 h-40 bg-coffee-200 dark:bg-coffee-700 rounded-full -z-10 opacity-50 blur-2xl"
                aria-hidden="true"
              ></div>
              <div
                className="absolute -bottom-10 -right-10 w-60 h-60 bg-cream-200 dark:bg-coffee-800 rounded-full -z-10 opacity-50 blur-2xl"
                aria-hidden="true"
              ></div>
            </div>
            ...
            <div className="order-1 lg:order-2">
              ...
              >
                ...
                <h2
                  ...
                  className="text-5xl md:text-7xl font-serif font-bold text-coffee-900 dark:text-white mb-8 leading-none"
                >
                ...
                <div className="grid grid-cols-2 gap-12 mb-12 border-t border-b border-coffee-200 dark:border-coffee-700 py-8">
                  <div>
                    <h4 className="text-4xl font-bold text-coffee-900 dark:text-white mb-2">
                      100%
                    </h4>
                    <p className="text-coffee-500 dark:text-coffee-400 font-medium uppercase tracking-wide text-sm">
                      {t("home.philosophy.stat1")}
                    </p>
                  </div>
                  <div>
                    <h4 className="text-4xl font-bold text-coffee-900 dark:text-white mb-2">
                ...
                <Button
                  ...
                  className="h-14 px-10 text-lg shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300"
                >
