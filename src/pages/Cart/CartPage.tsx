  ...
  return (
    <div className="min-h-screen bg-cream-50 dark:bg-coffee-950 pt-6">
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <h1 className="text-3xl md:text-5xl font-serif font-bold mb-8 md:mb-10 text-coffee-900 dark:text-white">
          {t("checkout.title")}
        </h1>
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-3/5">
            <div className="bg-cream-50 dark:bg-coffee-900 rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-10 border border-coffee-100 dark:border-coffee-800 shadow-sm">
              ...
              <div className="flex justify-between items-center mb-6">
                <h3 className="font-serif font-bold text-xl text-coffee-900 dark:text-white">
                  {t("checkout.contactInfo")}
                </h3>
                <button className="text-sm font-medium text-coffee-600 dark:text-coffee-300 hover:text-coffee-900 dark:hover:text-white transition-colors">
                  {t("common.edit")}
                </button>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                  ...
                  <div className="space-y-2">
                    <Label
                      htmlFor="email"
                      className={
                        errors.email ? "text-error" : "dark:text-coffee-100"
                      }
                    >
                      {t("settings.email")}
                    </Label>
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    <Label
                      htmlFor="address"
                      className={
                        errors.address ? "text-error" : "dark:text-coffee-100"
                      }
                    >
                      {t("checkout.address")}
                    </Label>
          ...
          <div className="w-full lg:w-2/5">
            <div className="bg-coffee-900 dark:bg-coffee-800 text-white rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-10 h-full flex flex-col shadow-xl">
              <h3 className="font-serif font-bold text-2xl mb-6 md:mb-8">
                {t("cart.summary")}
              </h3>
                ...
                {items.length === 0 ? (
                  <div className="text-center py-10 text-coffee-300">
                    ...
                    <Button
                      ...
                      className="!border-white !text-white hover:!bg-white hover:!text-coffee-900 dark:hover:!bg-coffee-700 dark:hover:!text-white"
                    >
                      {t("cart.browseMenu")}
                    </Button>
                  </div>
                      ...
                      <div className="flex-1 flex flex-col justify-between py-0.5">
                        <div className="flex justify-between items-start gap-2">
                          <div>
                            ...
                            <p className="text-xs text-coffee-300 capitalize">
                              {item.category}
                            </p>
                          </div>
                        ...
                        <div className="flex items-center justify-between mt-2">
                          ...
                          <AlertDialog>
                            <AlertDialogTrigger asChild>
                              <button
                                className="text-coffee-400 hover:text-error transition-colors p-2"
