        ...
        <div className="md:hidden sticky top-[100px] z-30 bg-white/95 dark:bg-coffee-950/95 backdrop-blur-md -mx-4 px-4 py-3 mb-6 shadow-sm transition-all">
            <div className="flex items-center justify-between mb-3">
                <h1 className="text-2xl font-serif font-bold text-coffee-900 dark:text-white">
                    {t('nav.menu')} <span className="text-sm text-coffee-500 font-sans font-normal">({filteredProducts.length})</span>
                </h1>
            </div>
            ...
            <div className="space-y-3">
                ...
                <div className="relative">
                    <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-coffee-400 pointer-events-none" />
                    <Input 
                        type="text" 
