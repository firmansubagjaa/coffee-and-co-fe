  ...
  if (item.children) {
    return (
      <div
        className={cn(
          "mb-2",
          item.separatorAfter && "mb-6 pb-4 border-b border-coffee-800/30"
        )}
      >
        <button
      ...
      <div className="p-6 pb-2">
        <div className="flex items-center gap-3 mb-8 px-2">
          ...
          <div>
            ...
            <span className="text-[10px] text-coffee-400 uppercase tracking-widest font-bold">
              {t("dashboard.header.adminPortal")}
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 bg-coffee-800/30 p-3 rounded-2xl border border-coffee-700/30 backdrop-blur-sm mb-4">
          ...
          <div className="overflow-hidden">
            ...
            <p className="text-[10px] text-coffee-400 capitalize truncate tracking-wide">
      ...
      <div className="p-4 border-t border-coffee-800/30 bg-[#1C1917]">
        ...
        <AlertDialog>
          <AlertDialogTrigger asChild>
            <button className="flex items-center gap-3 px-4 py-3 text-coffee-400 hover:bg-error/10 hover:text-error w-full rounded-xl transition-all duration-200 group">
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>
                {t("dashboard.header.signOutDialog.title")}
              </AlertDialogTitle>
              <AlertDialogDescription>
            ...
            <AlertDialogFooter>
              <AlertDialogCancel>
                {t("dashboard.header.signOutDialog.cancel")}
              </AlertDialogCancel>
        ...
        <header className="bg-white/80 dark:bg-coffee-900/80 backdrop-blur-md border-b border-gray-200 dark:border-coffee-800 h-20 hidden md:flex items-center justify-between px-8 sticky top-0 z-10 transition-all">
          ...
          <div className="flex gap-4 items-center">
            <div className="text-right hidden lg:block mr-2">
              <p className="text-xs font-bold text-coffee-900 dark:text-coffee-200">
                {new Date().toLocaleDateString(
                  language === "id" ? "id-ID" : "en-US",
                  { weekday: "long", month: "long", day: "numeric" }
                )}
              </p>
              <p className="text-[10px] text-coffee-500 dark:text-coffee-400 uppercase tracking-wider">
                {t("dashboard.header.systemOperational")}
              </p>
            </div>
