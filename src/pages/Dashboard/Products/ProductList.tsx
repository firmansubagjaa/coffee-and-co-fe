...
export const ProductList: React.FC = () => {
  ...
  const handleExport = (format: string) => {
    ...
    toast.success(
      t("dashboard.products.toast.exported", { format: format.toUpperCase() })
    );
  };
            ...
            <tbody className="divide-y divide-coffee-50 dark:divide-coffee-800">
              {filteredProducts.length === 0 ? (
                <tr>
                  <td
                    colSpan={5}
                    className="px-6 py-12 text-center text-coffee-500"
                  >
                      ...
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <AlertDialog>
                          <AlertDialogTrigger asChild>
                            <button className="p-2 text-coffee-500 dark:text-coffee-400 hover:text-error hover:bg-error/10 dark:hover:bg-error/20 rounded-lg transition-colors">
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              <AlertDialogTitle>
                                {t("dashboard.products.deleteDialog.title")}
                              </AlertDialogTitle>
                              <AlertDialogDescription>
                                {t("dashboard.products.deleteDialog.desc", {
                                  name: product.name,
                                })}
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
                              <AlertDialogCancel>
                                {t("dashboard.products.deleteDialog.cancel")}
                              </AlertDialogCancel>
                              <AlertDialogAction
                                onClick={() =>
