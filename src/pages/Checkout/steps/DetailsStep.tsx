  ...
  return (
    <div className="animate-in fade-in slide-in-from-right-4 duration-500">
      <div className="bg-white dark:bg-coffee-900 rounded-[2rem] p-6 md:p-8 shadow-sm border border-coffee-100 dark:border-coffee-800 mb-6">
        <h2 className="text-2xl font-serif font-bold text-coffee-900 dark:text-white mb-6">{t('checkout.contactInfo')}</h2>
        ...
        <form id="details-form" onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="space-y-2">
            ...
            <Input 
              id="fullName"
              className={cn("h-12", errors.fullName && "border-red-500 focus-visible:ring-red-400")}
              {...register("fullName")}
            />
          ...
          <div className="space-y-2">
            <Label htmlFor="deliveryNote" className="dark:text-coffee-100">{t('checkout.deliveryNote')}</Label>
            <Input 
              id="deliveryNote"
