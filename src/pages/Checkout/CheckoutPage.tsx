...
export const CheckoutPage: React.FC = () => {
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 2:
        return <PaymentStep onNext={handlePaymentSelect} onBack={handleBack} initialMethod={paymentMethod} />;
      case 3:
        return <ReviewStep 
                ...
                <div key={step.id} className="flex items-center gap-2 md:gap-4">
                  <div className={cn(
                    ...
                    <span className={cn(
                      ...
                      {isCompleted ? <CheckCircle className="w-4 h-4 md:w-5 md:h-5" /> : idx + 1}
                    </span>
                    <span className={cn(
                  ...
                  {idx < STEPS.length - 1 && (
                    <div className={cn(
                      ...
                      isCompleted ? "bg-green-500/50" : "bg-coffee-100 dark:bg-coffee-800"
                    )} />
                  )}
                </div>
              );
