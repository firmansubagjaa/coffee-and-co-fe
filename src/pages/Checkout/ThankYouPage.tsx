  ...
  return (
    <div className="min-h-screen bg-coffee-900 pt-6 pb-20 px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-2xl relative z-10">
        ...
        >
          <div className="w-24 h-24 bg-success/20 rounded-full flex items-center justify-center mx-auto mb-6 backdrop-blur-sm border border-success/30">
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
        ...
        >
          ...
          <div className="bg-coffee-50 p-8 text-center border-b border-dashed border-coffee-200">
            <p className="text-sm font-bold text-coffee-400 uppercase tracking-widest mb-2">
              Order Receipt
            </p>
          ...
          <div className="p-8">
              ...
              {order.items.map((item: any) => (
                <div key={item.id} className="flex justify-between items-start">
                  <div className="flex gap-3">
                    <span className="font-mono font-bold text-coffee-400 w-6">
                      {item.quantity}x
                    </span>
                    <div>
            ...
            <div className="bg-coffee-50 rounded-xl p-4 flex items-start gap-3 mb-8">
              ...
              <div>
                <p className="font-bold text-coffee-900 text-sm mb-1">
                  Delivery Location
                </p>
            ...
            <div className="flex flex-col items-center justify-center gap-2 opacity-40 mb-2">
              <div
                className="h-12 w-full max-w-[200px] bg-coffee-900"
                style={{
                  maskImage:
                    "repeating-linear-gradient(90deg, black, black 2px, transparent 2px, transparent 4px)",
                }}
              ></div>
              <p className="font-mono text-xs tracking-[0.5em]">
                {order.id.replace("#", "")}
              </p>
            </div>
          </div>
          ...
          {/* Jagged Bottom Edge */}
          <div
            className="h-4 bg-white w-full relative"
            style={{
              backgroundImage:
                "linear-gradient(45deg, transparent 75%, #1c1917 75%), linear-gradient(-45deg, transparent 75%, #1c1917 75%)",
