export const en = {
  ...
  about: {
    ...
    careers: {
      ...
      application: {
        ...
        form: {
          ...
          coverLetterPlaceholder: "Tell us why you're perfect for this role...",
        },
        validation: {
          ...
          cvFormat: "Only PDF files allowed (max 5MB)",
        },
      ...
      applicationSuccess: {
        ...
        jobApplied: "Position Applied",
        nextSteps: {
          title: "What's Next?",
          step1: "Our team will review your application",
          step2: "You'll be contacted for next steps",
          step3: "Track your status anytime",
        },
    ...
    myApplications: {
      ...
      empty: "You haven't applied to any positions yet",
      exploreJobs: "Start exploring our open positions",
      browseJobs: "Browse Jobs",
      appliedOn: "Applied on",
      currentStatus: "Current Status",
      allStatus: "All Status",
      showing: "Showing {count} of {total} applications",
      statusLabels: {
        new: "New",
        reviewing: "Reviewing",
