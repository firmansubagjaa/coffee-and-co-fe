export const id = {
  common: {
    search: "Temukan favoritmu...",
    searchPlaceholder: "Jelajahi menu kami...",
  ...
  nav: {
    ...
    ourStoryDesc: "Dari awal yang sederhana hingga cangkir Anda.",
    careers: "Karir",
    careersDesc: "Bergabunglah dengan tim kami yang bersemangat.",
    locations: "Lokasi",
    locationsDesc: "Temukan kafe di dekat Anda.",
    rewards: "Rewards",
    signIn: "Masuk",
    signOut: "Keluar",
    profile: "Profil",
  ...
  menu: {
    ...
    filters: {
      category: "Kategori",
      price: "Rentang Harga",
      roast: "Tingkat Sangrai",
      dietary: "Diet",
      under5: "Di bawah $5",
      "5to10": "$5 - $10",
      light: "Sangrai Ringan",
      medium: "Sangrai Sedang",
      dark: "Sangrai Gelap",
      vegan: "Vegan",
  ...
  product: {
    ...
    originRoast: "Asal & Sangrai",
    shippingReturns: "Pengiriman & Pengembalian",
    shippingText: "Gratis ongkir untuk pesanan di atas $30.0",
    freshnessText: "Kesegaran dijamin. Pengembalian diterima dalam 30 hari.",
    ...
    addedToCartDesc: "{desc} ditambahkan ke pesanan Anda.",
  ...
  rewards: {
    ...
    freePastry: "Pastry Gratis",
    daysToUnlock: "{current}/{total} hari lagi",
    freeEspresso: "Espresso Gratis",
    redeemPoints: "Tukar {points} poin",
    redeem: "Tukar",
    tierStatus: "Status Tingkatan",
  ...
  auth: {
    ...
    verifyOtp: {
      ...
      subtitle: "Kami mengirimkan kode ke",
      label: "Kode Verifikasi",
      submit: "Verifikasi Kode",
      submitting: "Memverifikasi...",
      resendText: "Tidak menerima email?",
      resendLink: "Klik untuk kirim ulang",
      backToLogin: "Kembali ke Masuk",
      tip: "Tip: Untuk demo ini, gunakan kode",
    ...
    resetPassword: {
      ...
      subtitle: "Harus minimal 8 karakter.",
  ...
  dashboard: {
    ...
    analytics: {
      ...
      customerRetention: "Retensi Pelanggan (Kohort)",
      cohort: "Kohort",
      month: "Bulan",
    ...
    finance: {
      ...
      subtitle: "Pelacakan kinerja keuangan, valuasi bisnis, dan log keamanan.",
      ...
      incomeStatement: "Laporan Laba Rugi (Bulanan)",
      income: "Pendapatan",
      cogs: "Harga Pokok Penjualan (HPP)",
      opex: "Biaya Operasional (OpEx)",
      businessValuation: "Valuasi Bisnis",
      annualizedNetProfit: "Laba Bersih Disetahunkan",
      addBacks: "Add-Backs",
      sde: "SDE (Pendapatan Diskresioner Penjual)",
      industryMultiplier: "Pengali Industri",
      estimatedValuation: "Estimasi Valuasi",
      systemAuditLogs: "Log Audit Sistem",
      timestamp: "Waktu",
      user: "Pengguna",
      module: "Modul",
      action: "Tindakan",
    ...
    inventory: {
      ...
      subtitle: "Lacak tingkat stok, nilai par, dan valuasi aset.",
      report: "Laporan",
      addItem: "Tambah Item",
      ...
      action: "Tindakan",
      restock: "Restock",
      noItems: "Tidak ada item inventaris yang cocok dengan filter Anda.",
      restockSuccess: "Permintaan Restock Terkirim",
      ...
      form: {
        ...
        subtitle: "Daftarkan item stok baru.",
    ...
    transactions: {
      title: "Transaksi",
      subtitle: "Ringkasan transaksi terbaru Anda",
      totalVolume: "Total Volume",
      successfulPayments: "Pembayaran Berhasil",
      refunds: "Pengembalian Dana",
      searchPlaceholder: "Cari ID transaksi, pelanggan...",
      id: "ID Transaksi",
      customer: "Pelanggan",
      date: "Tanggal",
      amount: "Jumlah",
      payment: "Pembayaran",
      noTransactions: "Tidak ada transaksi yang cocok dengan kriteria Anda.",
      showingRecent: "Menampilkan {count} transaksi terbaru",
      exportSuccess: "Laporan diekspor sebagai {format}",
      export: "Ekspor",
      status: {
        all: "Semua",
        completed: "Selesai",
    ...
    users: {
      ...
      subtitle: "Kelola akses, peran, dan akun pengguna.",
      ...
      changeRoleDesc: "Mengubah izin akses untuk {name}.",
      selectRole: "Pilih Peran Baru",
      note: "Catatan: Mengubah peran akan segera memperbarui izin akses dasbor pengguna.",
      saveChanges: "Simpan Perubahan",
      noUsers: "Tidak ada pengguna yang cocok dengan filter Anda.",
      showingUsers: "Menampilkan {count} pengguna",
      roleUpdated: "Peran diperbarui untuk {name}",
      ...
      dialog: {
        ...
        desc: "Mengubah izin akses untuk {name}.",
        selectLabel: "Pilih Peran Baru",
    ...
    orders: {
      detail: {
        title: "Pesanan #{id}",
        subtitle: "Dibuat pada {date} • {count} item",
        print: "Cetak Pesanan",
    ...
    jobs: {
      ...
      subtitle: "Kelola posisi terbuka dan rekrutmen.",
    ...
    locations: {
      title: "Lokasi Toko",
      subtitle: "Kelola gerai fisik dan jam operasional.",
    ...
    logistics: {
      ...
      fridgeSafety: "Keamanan Kulkas",
      checkAuto: "Cek: Otomatis",
      optimalZone: "Zona Optimal",
      highTemp: "Peringatan: Suhu Tinggi",
      haccpLog: "Log HACCP diperbarui otomatis.",
      markEmpty: "Tandai Kosong",
      levels: {
        high: "Tinggi",
        low: "Rendah",
        out: "Habis"
    ...
    bi: {
      ...
      subtitle: "Model prediktif dan eksplorasi data tingkat lanjut.",
      dataSources: "Sumber Data",
      churn: {
        title: "Prediksi Risiko Churn",
        modelInfo: "Model ML: XGBoost v2.4 (Akurasi: 92%)",
        active: "Model Aktif",
        table: {
      ...
      forecast: {
        ...
        subtitle: "Kebutuhan inventaris yang diprediksi AI untuk minggu depan.",
        predicted: "{percent}% Diprediksi",
        stable: "Stabil",
    ...
    admin: {
      ...
      report: "Laporan",
      deepDive: "Analisis Mendalam",
      revenueTrend: "Tren Pendapatan",
      avgOrderTime: "Rata-rata Waktu Pesanan",
      customerSatisfaction: "Kepuasan Pelanggan",
      topStaff: "Staf Terbaik",
      manageStaff: "Kelola Staf",
      thisWeek: "Minggu Ini",
      morningBriefing: "Briefing Pagi",
      requiresAttention: "Perlu Perhatian",
      issues: "Masalah",
      resolve: "Selesaikan",
      allSystemsNominal: "Semua sistem normal.",
      last7Days: "Performa 7 Hari Terakhir",
      goals: {
      ...
      alerts: {
        ...
        finance: "Keuangan",
        staff: "Staf",
        stockCritical: "Stok Oat Milk kritis (< 10%)",
        refundSpike: "Lonjakan pengembalian dana tidak wajar (3 dlm 1 jam)",
        lateClockIn: "Absen masuk terlambat (2 staf)",
      },
    ...
    barista: {
      ...
      avgTktTime: "Rata-rata Waktu",
      startPrep: "Mulai Siapkan",
  ...
  cart: {
    ...
    removeDesc: "Apakah Anda yakin ingin menghapus item ini dari keranjang?",
    subtotal: "Subtotal",
    shipping: "Pengiriman",
    free: "Gratis",
    title: "Pilihan Anda",
  ...
  thankYou: {
    ...
    viewHistory: "Lihat Riwayat Pesanan",
  },
  checkout: {
    title: "Checkout",
    ...
    validation: {
      ...
      addressShort: "Alamat terlalu pendek",
    },
    payment: {
      title: "Pilih Metode Pembayaran",
      secure: "Pembayaran Aman",
      poweredBy: "Didukung oleh Midtrans",
      total: "Total",
      methods: {
      ...
      doNotClose: "Mohon jangan tutup jendela ini.",
      successDesc: "Transaksi Anda telah diproses dengan aman.",
