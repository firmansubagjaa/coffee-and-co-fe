export const id = {
  ...
  about: {
    ...
    careers: {
      ...
      application: {
        title: "Lamar untuk {position}",
        subtitle: "Kirimkan lamaran Anda",
        form: {
        ...
        validation: {
          ...
          cvFormat: "Hanya file PDF yang diperbolehkan (maks 5MB)",
        },
      ...
      applicationSuccess: {
        ...
        subtitle: "Lamaran Anda telah kami terima",
        jobApplied: "Posisi yang Dilamar",
        nextSteps: {
          title: "Langkah Selanjutnya?",
          step1: "Tim kami akan meninjau lamaran Anda",
          step2: "Anda akan dihubungi untuk langkah selanjutnya",
          step3: "Pantau status Anda kapan saja",
        },
        viewApplications: "Lihat Lamaran Saya",
        backToCareers: "Kembali ke Karir",
      },
    },
    myApplications: {
      ...
      empty: "Anda belum melamar posisi apapun",
      exploreJobs: "Mulai jelajahi posisi yang tersedia",
      browseJobs: "Lihat Pekerjaan",
      appliedOn: "Melamar pada",
      currentStatus: "Status Saat Ini",
      allStatus: "Semua Status",
      showing: "Menampilkan {count} dari {total} lamaran",
      statusLabels: {
        new: "Baru",
        reviewing: "Ditinjau",
